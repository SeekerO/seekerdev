    ...
    return <div className="flex flex-col items-center w-48 h-48 justify-center perspective-1000 relative group cursor-pointer">
        ...
        {isHovered && (
            <motion.div
                ...
                className="h-20 absolute ml-[150px] mt-[70px] -translate-x-1/2 -translate-y-1/2 z-20 overflow-hidden items-center flex justify-center"
            >
                <LottiePlayer
                    autoplay
                    loop
