...
const Sidebar = ({ scrollToHero, scrollToProjects, scrollToTechStack, scrollToAbout, handleOpenContacts, handleOpenSidebar, openSidebar, isUserScrolling }: SidebarProps) => {
